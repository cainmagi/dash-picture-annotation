...
const variables = {
  ...
  sourceURIs: {
    "v0.2.1": {
      ...
      "typehints.AnnoMark": "typehints.py#L51",
      "typehints.AnnoItem": "typehints.py#L89",
      "typehints.Annotations": "typehints.py#L112",
      "typehints.AnnoStyle": "typehints.py#L125",
      "typehints.DashSelectOptionItem": "typehints.py#L182",
      "typehints.Size": "typehints.py#L194",
      "typehints.Scale": "typehints.py#L210",
      "typehints.NSAnnoItem": "typehints.py#L234",
      "typehints.NSAnnotations": "typehints.py#L249",
      "typehints.is_sequence_of": "typehints.py#L253",
      "typehints.is_anno_mark": "typehints.py#L269",
      "typehints.is_anno_item": "typehints.py#L281",
      "typehints.is_annotations": "typehints.py#L295",
      "typehints.is_dash_select_option_item": "typehints.py#L311",
      utilities: "utilities.py",
      "utilities.get_data_item": "utilities.py#L58",
      "utilities.get_data_item_with_default": "utilities.py#L85",
      "utilities.get_data_items": "utilities.py#L129",
      "utilities.get_data_items_by_regex": "utilities.py#L185",
      "utilities.get_all_ids": "utilities.py#L255",
      "utilities.get_all_comments": "utilities.py#L284",
      "utilities.compare_anno_marks": "utilities.py#L318",
      "utilities.sanitize_data_item": "utilities.py#L413",
      "utilities.sanitize_data": "utilities.py#L488",
      "utilities.sanitize_scale": "utilities.py#L550",
    },
    "v0.1.2": {
      ".": "__init__.py",
      DashPictureAnnotation: "__init__.py#L30",
