...
This demo script will be used in the following parts of this guide. By default, i.e.,
when launching the app in the initial state, users should be able to see the
white annotation boxes.
