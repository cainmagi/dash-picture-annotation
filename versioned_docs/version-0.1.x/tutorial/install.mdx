...
```shell
pip install dash-picture-annotation==0.1.2
```
...
```shell
pip install dash-picture-annotation[option1,option2...]==0.1.2
```

| Option | <center>Supports</center>                                                                                                              |
| :----: | :------------------------------------------------------------------------------------------------------------------------------------- |
| `test` | Install the dependencies related to [`pytest`][link-pytest]. These dependencies are not used by the package but used by the unittests. |
...
```shell
git clone -b v0.1.2 https://github.com/cainmagi/dash-picture-annotation
...
when `dash_picture_annotation` is imported anywhere.
