...
|     `selected_id`      |                                                                   `str \| None`                                                                    | <p>The ID of the currently selected annotator.</p><p>This property is read-only. It will be automatically set when users select an annotator. A valid ID is a string. When no annotator is selected, this property returns `None`.</p>                                                                                |
